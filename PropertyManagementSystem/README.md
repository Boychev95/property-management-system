...
- Tenants
- Payments
- Потребителска автентикация и авторизация
Проектът използва ASP.NET Core Identity, Entity Framework Core, SQL Server и Bootstrap 5.
...
- Финансова прецизност decimal(18,2)
...
- Tenant → Payments (1:N)
- Identity таблици (AspNetUsers, AspNetRoles и др.)
